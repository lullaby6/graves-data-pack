...
# tellraw @s [{"text":"- ","color":"gray"},{"text":"Reset All Players","color":"red","hover_event":{"action":"show_text","value":[{"text":"Click to reset all players"}]},"click_event":{"action":"run_command","command":"/function graves:config/commands/reset/players"}}]
