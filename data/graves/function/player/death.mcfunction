...
# Check if the player died from lava
execute if block ~ ~ ~ minecraft:lava run return run function graves:player/death/lava
...
# Skip spawning a grave if the player died from lava
execute unless block ~ ~ ~ minecraft:lava run function graves:grave/spawn with storage graves:main
