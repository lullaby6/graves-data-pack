...
execute store result storage graves:main data.x int 1 run scoreboard players get @s graves.player.death.pos.x
execute store result storage graves:main data.y int 1 run scoreboard players get @s graves.player.death.pos.y
execute store result storage graves:main data.z int 1 run scoreboard players get @s graves.player.death.pos.z

execute store result storage graves:main data.player_id int 1 run scoreboard players get @s graves.player.id

scoreboard players add . graves.grave.id 1
execute store result storage graves:main data.grave_id int 1 run scoreboard players get . graves.grave.id

function graves:grave/spawn with storage graves:main data

data remove storage graves:main data
